            ...
            <div className="flex-1">
                ...
                {editing ? (
                    <form onSubmit={submit}>
                        {/* Menggunakan React Quill sebagai editor */}
                        <ReactQuill
                            value={data.message}
                    ...
                    <div
                        className="prose mt-4 text-lg text-gray-900"
                        dangerouslySetInnerHTML={{ __html: chirp.message }}
                    ></div>
                )}
                {/* Menampilkan foto hanya jika ada */}
                {chirp.photo && (
                    <div className="relative w-full h-64 overflow-hidden border border-gray-300 rounded-lg mt-4">
                        <img
